...
```bash
npx @executeautomation/playwright-mcp-server --http --port 8000 --path /mcp --host-name your.host
```

Or Docker:

```bash
docker run --rm -p 8000:8000 ghcr.io/executeautomation/mcp-playwright:latest \
